...
class TestSimulatorSchedulerStart:
    ...
    def mock_settings(self):
        ...
        with patch('app.services.scheduler_service.settings') as mock:
    ...
    def mock_azure_storage(self):
        ...
        with patch('app.services.scheduler_service.azure_storage') as mock:
    ...
    def mock_model_client(self):
        ...
        with patch('app.services.scheduler_service.model_client') as mock:
    ...
    async def test_start_scheduler_azure_connection_failure(self, scheduler, mock_settings, mock_azure_storage, mock_model_client):
        ...
        mock_azure_storage.connect.side_effect = Exception(
...
class TestSimulatorDataCollection:
    ...
    def mock_anomaly_logger(self):
        """Mock anomaly logger"""
        with patch('app.services.scheduler_service.anomaly_logger') as mock:
    ...
    async def test_simulate_data_collection_exception_handling(self, scheduler, mock_azure_storage, mock_anomaly_logger, capsys):
        ...
        mock_azure_storage.simulate_real_time_data.side_effect = Exception(
            "Storage error")
