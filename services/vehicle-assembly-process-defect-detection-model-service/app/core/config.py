...
class Settings(BaseSettings):
    ...
    # 모델 예측 타임아웃 (초)
    PREDICTION_TIMEOUT: int = Field(default=10, env="PREDICTION_TIMEOUT")
    ...
    # 더미 예측 사용 (개발용)
    USE_DUMMY_PREDICTIONS: bool = Field(default=False, env="USE_DUMMY_PREDICTIONS")
    ...
    HF_OFFLINE: bool = Field(default=False, env="HF_OFFLINE")
    ...
    RETURN_CLASS_PROBABILITIES: bool = Field(
        default=True,
        env="RETURN_CLASS_PROBABILITIES"
    )
...
class ModelConfigs:
    ...
    # 의장공정 특화 모델 (실제 훈련된 모델로 교체 필요)
    DEFECT_DETECTION_V1 = {
        "MODEL_NAME": "your-organization/car-defect-detector-v1",
        "MODEL_PATH": "your-organization/car-defect-detector-v1",
        "MODEL_VERSION": "1.0.0"
    }

    DEFECT_DETECTION_V2 = {
        "MODEL_NAME": "your-organization/car-defect-detector-v2",
        "MODEL_PATH": "your-organization/car-defect-detector-v2",
        "MODEL_VERSION": "2.0.0"
    }
...
def get_model_config(model_type: str = "resnet50") -> dict:
    """
    모델 타입에 따른 설정 반환
    ...
    configs = {
        ...
        "vit": ModelConfigs.VIT_BASE,
        "defect_v1": ModelConfigs.DEFECT_DETECTION_V1,
        "defect_v2": ModelConfigs.DEFECT_DETECTION_V2,
        "local": ModelConfigs.LOCAL_FINETUNED
    }

    return configs.get(model_type, ModelConfigs.RESNET50_BASE)
...
class DevelopmentSettings(Settings):
    ...
    DEBUG: bool = True
    LOG_LEVEL: str = "DEBUG"
    USE_DUMMY_PREDICTIONS: bool = True  # 개발시 더미 예측 사용 가능
