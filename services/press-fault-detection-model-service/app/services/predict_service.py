...
def predict(data: SensorData) -> dict:
    ...
    try:
        ...
        per_feature_squared_errors = np.power(reconstructed_last_steps - original_last_steps, 2)
        ...
        if is_fault:
            ...
            attribute_errors_dict = dict(zip(FEATURE_NAMES, faulty_attribute_errors.astype(float)))
