...
class TestPredictEndpoint:
    ...
    def test_predict_with_extreme_values(self, mock_predict):
        ...
        extreme_values = [-1e6] * 256 + [1e6] * 256
        sensor_data = {
            "signal_type": "vib",
...
class TestPredictEndpointErrorHandling:
    ...
    def test_predict_handles_file_not_found_error(self, mock_predict):
        ...
        mock_predict.side_effect = FileNotFoundError("Model file missing for vib")
    ...
    def test_predict_handles_value_error_invalid_signal_type(self, mock_predict):
        ...
        mock_predict.side_effect = ValueError("signal_type must be either 'cur' or 'vib'")
    ...
    def test_predict_handles_value_error_wrong_length(self, mock_predict):
        ...
        mock_predict.side_effect = ValueError("values must have exactly 512 elements for signal_type 'vib'")
    ...
    def test_predict_handles_runtime_error_from_prediction_pipeline(self, mock_predict):
        ...
        mock_predict.side_effect = RuntimeError("Prediction pipeline failed: model prediction error")
    ...
    def test_predict_handles_generic_exception(self, mock_predict):
        ...
        mock_predict.side_effect = AttributeError("'NoneType' object has no attribute 'transform'")
...
class TestPredictEndpointValidation:
    ...
    def test_predict_mixed_values_types(self):
        ...
        sensor_data = {
            "signal_type": "vib",
            "values": [1.0, "2.0", 3]  # String in middle
        }
    ...
    def test_predict_invalid_json_format(self):
        ...
        response = client.post(
            "/predict",
            data='{"signal_type": "vib", "values": [1.0, 2.0,}',  # Trailing comma
    ...
    def test_predict_additional_fields_ignored(self):
        ...
        assert response.status_code in [200, 400, 500]  # Not 422 for extra fields
